...
from tf_dcsrn.LRbyFFT import getLR
...
class ImageDataProvider(BaseDataProvider):
    ...
    def __init__(self, search_path, a_min=None, a_max=None, data_suffix=".nii.gz", mask_suffix='_mask.tif', shuffle_data=True, n_class = 2):
...
class MedicalImageDataProvider(BaseDataProvider):
    ...
    def __init__(self, search_path = '/home/psoni/Desktop/project/psoni/MRISR/Train/*.nii.gz', a_min=None, a_max=None, shuffle_data=True):
...
class TestDataProvider(BaseDataProvider):
    ...
    def __init__(self, search_path = '/home/psoni/Desktop/project/psoni/MRISR/Test/*.nii.gz', a_min=None, a_max=None, shuffle_data=False):
        super(TestDataProvider, self).__init__(a_min, a_max)
        self.file_idx = -1
        self.shuffle_data = shuffle_data
        self.channels = 3
